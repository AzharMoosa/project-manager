  ...
  const [projects, setProjects] = useState([
    {
      ...
      tasks: [
        ...
        { task: "Todo List for Each Project", complete: false, id: 1 },
        { task: "Track Progress", complete: true, id: 1 },
        { task: "Priority List", complete: true, id: 1 },
        { task: "Choose Tools In Each Project", complete: false, id: 1 },
        { task: "Clean And Simple Design", complete: true, id: 1 },
        { task: "Use REACT", complete: false, id: 1 },
      ],
      color: "blue",
      date: "26/06/2020",
      id: 28392,
